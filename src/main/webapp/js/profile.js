...
//                   '<td>' + habitacion.descripcion + '</td>' +
                    '<td>' + habitacion.fecha_ingreso + '</td>' 
//                    +'<td><button id="devolver-btn" onclick= "devolverhabitacion(' + habitacion.id 
...
function devolverHabitacion(id) {
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            if (result != false) {
                ...
                console.log("Error devolviendo Habitacion");
            }
        }
    });
